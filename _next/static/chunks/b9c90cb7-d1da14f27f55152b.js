...
`,Y="auto",Q=R(E.E.div)`
  ...
  ${e=>{switch(e.$useTheme){case"web95":return Y="light",U.web95;case"retro":return Y="light",U.retro;case"soft":return Y="light",U.soft;case"midnight":return Y="dark",U.midnight;case"minimal":return Y="light",U.minimal;case"rounded":return Y="light",U.rounded;case"nouns":return Y="light",U.nouns;default:if("light"===e.$useMode)return Y="light",U.light;if("dark"===e.$useMode)return Y="dark",U.dark;return I.iv`
  ...
  ${e=>{switch(Y){case"light":return V;case"dark":return P;default:return I.iv`
          ${V}
          @media (prefers-color-scheme: dark) {
            ${P}
          }
...
`;let ex=R(E.E.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eo:ei} 150ms ease-out
    both;
`,eg=I.F4`
...
Por favor, tente conectar novamente.`,injectionScreen_notconnected_h1:`Fa\xe7a login no {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Para continuar, fa\xe7a login na sua extens\xe3o do {{ CONNECTORNAME }}.`,profileScreen_heading:"Conectado",switchNetworkScreen_heading:"Alternar rede",signInWithEthereumScreen_tooltip:"Voc\xea n\xe3o est\xe1 conectado a este aplicativo.\n**Entre com Ethereum** para continuar.",signInWithEthereumScreen_signedOut_heading:"Entrar com Ethereum",signInWithEthereumScreen_signedOut_h1:"Este aplicativo gostaria de verificar voc\xea \n como o propriet\xe1rio desta carteira.",signInWithEthereumScreen_signedOut_p:`Por favor, assine o pedido de mensagem 
 ...
 autentique novamente no futuro.`,signInWithEthereumScreen_signedIn_button:"Sair"},e_={connectWallet:"绑定钱包",disconnect:"解除绑定",connected:"已绑定",wrongNetwork:"错误网络",switchNetworks:"切换网络",chainNetwork:"{{ CHAIN }}网络",copyToClipboard:"复制到剪贴板",copyCode:"复制代码",moreInformation:"更多信息",back:"返回",close:"关闭",or:"或",more:"更多",tryAgain:"重试",tryAgainQuestion:"重试？",dontHaveTheApp:"没有该应用？",scanTheQRCode:"扫描二维码",useWalletConnectModal:"使用 WalletConnect 模态窗",useModal:"使用模态窗",installTheExtension:"安装扩展程序",getWalletName:"获取{{ CONNECTORNAME }}",otherWallets:"其他钱包",learnMore:"了解更多",getWallet:"获取钱包",approveInWallet:"在钱包中批准",confirmInWallet:"在钱包中确认",awaitingConfirmation:"等待确认",signIn:"登录",signOut:"登出",signedIn:"已登录",signedOut:"已登出",walletNotConnected:"钱包未绑定",warnings_walletSwitchingUnsupported:`您的钱包不支持从此应用切换网络。`,warnings_walletSwitchingUnsupportedResolve:`请尝试从钱包中切换网络。`,warnings_chainUnsupported:`此应用不支持当前连接的网络。`,warnings_chainUnsupportedResolve:`请切换网络或断开连接以继续。`,onboardingScreen_heading:`获取钱包`,onboardingScreen_h1:`开始探索 Web3`,onboardingScreen_p:`您的钱包是通往以太坊的一扇大门，而以太坊是探索 Web3 的一项神奇技术。`,onboardingScreen_ctaText:`选择您的第一钱包`,onboardingScreen_ctaUrl:"https://ethereum.org/zh/wallets/find-wallet/",aboutScreen_heading:`关于钱包`,aboutScreen_a_h1:`对于您的数字资产`,aboutScreen_a_p:`有了钱包，您可以发送、接收、存储数字资产及使用数字资产进行交互，例如 NFT 和其他以太坊通证等。`,aboutScreen_b_h1:`更好的登录方式`,aboutScreen_b_p:`使用现代应用，您的钱包可以用作简便的登录方法，而不必记住密码。`,aboutScreen_c_h1:`探索 Web3 世界`,aboutScreen_c_p:`您的钱包是一个重要的工具，可以让您探索并参与到快速发展的 Web3 世界。`,aboutScreen_ctaText:`了解更多`,aboutScreen_ctaUrl:"https://ethereum.org/zh/wallets/",connectorsScreen_heading:`绑定钱包`,connectorsScreen_newcomer:`我没有钱包`,connectorsScreen_h1:`什么是钱包？`,connectorsScreen_p:`钱包可用于发送、接收和存储数字资产。通过绑定钱包，您可以与应用进行交互。`,mobileConnectorsScreen_heading:`选择钱包`,scanScreen_heading:`手机扫描`,scanScreen_heading_withConnector:`手机扫描{{ CONNECTORNAME }}`,scanScreen_tooltip_walletConnect:`打开 [WALLETCONNECTLOGO] WalletConnect 支持的钱包进行扫描`,scanScreen_tooltip_default:`打开您手机上的{{ CONNECTORNAME }} 进行扫描`,downloadAppScreen_heading:`获取{{ CONNECTORNAME }}`,downloadAppScreen_iosAndroid:`使用手机相机扫描以下载 iOS 或 Android 应用。`,downloadAppScreen_ios:`使用手机相机扫描以下载 iOS 应用。`,downloadAppScreen_android:`使用手机相机扫描以下载 Android 应用。`,injectionScreen_unavailable_h1:`不支持的浏览器`,injectionScreen_unavailable_p:`要绑定您的{{ CONNECTORSHORTNAME }}钱包，请在{{ SUGGESTEDEXTENSIONBROWSER }}上安装此扩展程序。`,injectionScreen_install_h1:`安装{{ CONNECTORNAME }}`,injectionScreen_install_p:`要绑定您的{{ CONNECTORSHORTNAME }}钱包，请安装此浏览器扩展程序。`,injectionScreen_connecting_h1:`请求绑定`,injectionScreen_connecting_p:`打开{{ CONNECTORSHORTNAME }}浏览器 扩展程序以绑定您的钱包。`,injectionScreen_connecting_injected_h1:`请求绑定`,injectionScreen_connecting_injected_p:`通过您的钱包接受请求，以绑定到此应用。`,injectionScreen_connected_h1:`已绑定`,injectionScreen_connected_p:`现在可以关闭此弹窗`,injectionScreen_rejected_h1:`请求已取消`,injectionScreen_rejected_p:`您已取消请求。n点击上面可重试。`,injectionScreen_failed_h1:`绑定失败`,injectionScreen_failed_p:`抱歉，发生错误。请尝试重新绑定。`,injectionScreen_notconnected_h1:`登录{{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`要继续，请登录到您的{{ CONNECTORNAME }}扩展程序。`,profileScreen_heading:"已绑定",switchNetworkScreen_heading:"切换网络",signInWithEthereumScreen_tooltip:"您尚未登录到此应用。\n请选择**使用以太坊登录**以继续。",signInWithEthereumScreen_signedOut_heading:"使用以太坊登录",signInWithEthereumScreen_signedOut_h1:"此应用希望验证您是 此钱包的所有者。",signInWithEthereumScreen_signedOut_p:`请签署钱包中的消息请求 以继续。`,signInWithEthereumScreen_signedOut_button:"登录",signInWithEthereumScreen_signedIn_heading:"已使用以太坊登录",signInWithEthereumScreen_signedIn_h1:"您已成功验证自己 是此钱包的所有者。",signInWithEthereumScreen_signedIn_p:`登出后，将来您还需要 再次进行身份验证。`,signInWithEthereumScreen_signedIn_button:"登出"},getLocale=e=>{switch(e){case"es-ES":return ez;case"fr-FR":return eT;case"ja-JP":return eR;case"pt-BR":return eZ;case"zh-CN":return e_;default:return eD}};function useLocales(e){var o,t;let n=useContext(),i=null!==(t=null===(o=n.options)||void 0===o?void 0:o.language)&&void 0!==t?t:"en-US",r=(0,j.useMemo)(()=>getLocale(i),[i]);if(!r)return console.error(`Missing translations for: ${i}`),`Missing translations for: ${i}`;let a={};return Object.keys(r).map(o=>{let t=r[o];return a[o]=localize(t,e)}),a}let localize=(e,o)=>{let t=e;return o&&Object.keys(o).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),o[e])}),replaceMarkdown(t)},replaceMarkdown=e=>{let o=e;return o=(o=o.split("\n")).map((e,t)=>(0,y.jsxs)(j.Fragment,{children:[wrapTags(e),t<o.length-1&&(0,y.jsx)("br",{})]},t))},wrapTags=e=>{let o=e.split(/(\*\*[^\*]*\*\*)/g);return o.map((e,o)=>/(\*\*.*\*\*)/g.test(e)?(0,y.jsx)("strong",{children:e.replace(/\*\*/g,"")},o):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,y.jsx)("span",{className:"ck-tt-logo",children:(0,y.jsx)(J.WalletConnect,{})},e):e):e)},eH={debug:10,info:20,warn:30,error:40,none:100},eU="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?j.useLayoutEffect:j.useEffect,useFitText=({logLevel:e="info",maxFontSize:o=100,minFontSize:t=20,onFinish:n,onStart:i,resolution:r=5}={})=>{let a=eH[e],s=(0,j.useCallback)(()=>({calcKey:0,fontSize:o,fontSizePrev:t,fontSizeMax:o,fontSizeMin:t}),[o,t]),l=(0,j.useRef)(null),d=(0,j.useRef)(),c=(0,j.useRef)(!1),[p,u]=(0,j.useState)(s),{calcKey:h,fontSize:x,fontSizeMax:g,fontSizeMin:b,fontSizePrev:C}=p,f=null,[m]=(0,j.useState)(()=>new O.Z(()=>{f=window.requestAnimationFrame(()=>{c.current||(i&&i(),c.current=!0,u({...s(),calcKey:h+1}))})}));(0,j.useEffect)(()=>(l.current&&m.observe(l.current),()=>{f&&window.cancelAnimationFrame(f),m.disconnect()}),[f,m]);let v=l.current&&l.current.innerHTML;return(0,j.useEffect)(()=>{0===h||c.current||(v!==d.current&&(i&&i(),u({...s(),calcKey:h+1})),d.current=v)},[h,s,v,i]),eU(()=>{let e;if(0===h)return;let o=Math.abs(x-C)<=r,i=!!l.current&&(l.current.scrollHeight>l.current.offsetHeight||l.current.scrollWidth>l.current.offsetWidth),s=i&&x===C,d=x>C;if(o){s?(c.current=!1,a<=eH.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?u({fontSize:d?C:b,fontSizeMax:g,fontSizeMin:b,fontSizePrev:C,calcKey:h}):(c.current=!1,n&&n(x));return}let p=g,f=b;i?(e=d?C-x:b-x,p=Math.min(g,x)):(e=d?g-x:C-x,f=Math.max(b,x)),u({calcKey:h,fontSize:x+e/2,fontSizeMax:p,fontSizeMin:f,fontSizePrev:x})},[h,x,g,b,C,n,l,r]),{fontSize:x,ref:l}},FitText=({children:e})=>{let[o,t]=j.useState(!1),{fontSize:n,ref:i}=useFitText({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,y.jsx)("div",{ref:i,style:{visibility:o?"visible":"hidden",fontSize:`${n}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};FitText.displayName="FitText";let injected=()=>{let e="undefined"!=typeof window&&!!window.ethereum,o=isMobile()&&!e;return{id:"injected",name:"Browser Wallet",shortName:"browser",scannable:!1,logos:{default:(0,y.jsx)(J.Injected,{})},installed:!!(!o&&e)}},walletConnect=()=>({id:"walletConnect",name:"Other Wallets",logos:{default:(0,y.jsx)(J.WalletConnect,{}),mobile:(0,y.jsx)(J.OtherWallets,{}),transparent:(0,y.jsx)(J.WalletConnect,{background:!1}),connectorButton:(0,y.jsx)(J.OtherWallets,{}),qrCode:(0,y.jsx)(J.WalletConnect,{background:!0})},logoBackground:"var(--ck-brand-walletConnect)",scannable:!0,createUri:e=>e}),metaMask=()=>{let e=isMetaMask(),o=isMobile()&&!e;return{id:"metaMask",name:"MetaMask",logos:{default:(0,y.jsx)(J.MetaMask,{background:!0}),mobile:(0,y.jsx)(J.MetaMask,{background:!0}),transparent:(0,y.jsx)("div",{style:{transform:"scale(0.86)",position:"relative",width:"100%"},children:(0,y.jsx)(J.MetaMask,{})}),connectorButton:(0,y.jsx)("div",{style:{transform:"scale(1.1)"},children:(0,y.jsx)(J.MetaMask,{})})},logoBackground:"linear-gradient(0deg, var(--ck-brand-metamask-12), var(--ck-brand-metamask-11))",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/metamask",website:"https://metamask.io/download/",android:"https://play.google.com/store/apps/details?id=io.metamask",ios:"https://apps.apple.com/app/metamask/id1438144202",chrome:"https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn",firefox:"https://addons.mozilla.org/firefox/addon/ether-metamask/",brave:"https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn",edge:"https://microsoftedge.microsoft.com/addons/detail/metamask/ejbalbakoplchlghecdalmeeeajnimhm"},installed:!!(!o&&e),createUri:e=>isAndroid()?e:`https://metamask.app.link/wc?uri=${encodeURIComponent(e)}`}},infinityWallet=()=>{let e=isInfinityWallet();return{id:"infinityWallet",name:"Infinity Wallet",logos:{default:(0,y.jsx)(J.InfinityWallet,{}),mobile:(0,y.jsx)(J.InfinityWallet,{}),transparent:(0,y.jsx)(J.InfinityWallet,{}),appIcon:(0,y.jsx)(J.InfinityWallet,{}),connectorButton:(0,y.jsx)(J.InfinityWallet,{})},logoBackground:"#08a1d5",scannable:!1,downloadUrls:{download:"https://infinitywallet.io/download",website:"https://infinitywallet.io/download",chrome:"https://infinitywallet.io/download",firefox:"https://infinitywallet.io/download",brave:"https://infinitywallet.io/download",edge:"https://infinitywallet.io/download"},installed:!!e}},coinbaseWallet=()=>{let e=isCoinbaseWallet(),o=isMobile()&&!e;return{id:"coinbaseWallet",name:"Coinbase Wallet",shortName:"Coinbase",logos:{default:(0,y.jsx)(J.Coinbase,{}),mobile:(0,y.jsx)(J.Coinbase,{background:!0}),transparent:(0,y.jsx)(J.Coinbase,{background:!1}),appIcon:(0,y.jsx)(J.Coinbase,{background:!1}),connectorButton:(0,y.jsx)(J.Coinbase,{background:!0}),qrCode:(0,y.jsx)(J.Coinbase,{background:!0})},logoBackground:"var(--ck-brand-coinbaseWallet)",scannable:!0,installed:!!(!o&&e),downloadUrls:{download:"https://connect.family.co/v0/download/coinbasewallet",website:"https://www.coinbase.com/wallet/getting-started-extension",android:"https://play.google.com/store/apps/details?id=org.toshi",ios:"https://apps.apple.com/app/coinbase-wallet-store-crypto/id1278383455",chrome:"https://chrome.google.com/webstore/detail/coinbase-wallet-extension/hnfanknocfeofbddgcijnmhnfnkdnaad"},createUri:e=>`https://go.cb-w.com/wc?uri=${encodeURIComponent(e)}`}},rainbow=()=>{let e=isRainbow(),o=isMobile()||!e;return{id:"rainbow",name:"Rainbow",logos:{default:(0,y.jsx)(J.Rainbow,{}),mobile:(0,y.jsx)(J.Rainbow,{}),appIcon:(0,y.jsx)(J.Rainbow,{}),connectorButton:(0,y.jsx)(J.Rainbow,{round:!0})},logoBackground:"#174299",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/rainbow",website:"https://rainbow.me/?utm_source=connectkit",android:"https://play.google.com/store/apps/details?id=me.rainbow&referrer=utm_source%3Dconnectkit&utm_source=connectkit",ios:"https://apps.apple.com/app/rainbow-ethereum-wallet/id1457119021?pt=119997837&ct=connectkit&mt=8",chrome:"https://rainbow.me/extension?utm_source=connectkit",edge:"https://rainbow.me/extension?utm_source=connectkit",brave:"https://rainbow.me/extension?utm_source=connectkit"},installed:o?void 0:e,createUri:e=>isAndroid()?e:`https://rnbwapp.com/wc?uri=${encodeURIComponent(e)}&connector=connectkit`}},argent=()=>({id:"argent",name:"Argent",logos:{default:(0,y.jsx)(J.Argent,{})},logoBackground:"#fff",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/argent",android:"https://play.google.com/store/apps/details?id=im.argent.contractwalletclient",ios:"https://apps.apple.com/app/argent/id1358741926"},createUri:e=>isAndroid()?e:`https://argent.link/app/wc?uri=${encodeURIComponent(e)}`}),trust=()=>{let e=isTrust();return{id:"trust",name:"Trust Wallet",shortName:"Trust",logos:{default:(0,y.jsx)(J.Trust,{})},logoBackground:"#fff",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/trust",android:"https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp",ios:"https://apps.apple.com/app/trust-crypto-bitcoin-wallet/id1288339409"},installed:e,createUri:e=>isAndroid()?e:`https://link.trustwallet.com/wc?uri=${encodeURIComponent(e)}`}},ledger=()=>({id:"ledger",name:"Ledger Live",shortName:"Ledger",logos:{default:(0,y.jsx)(J.Ledger,{})},logoBackground:"#000",scannable:!1,downloadUrls:{website:"https://www.ledger.com/ledger-live/download#download-device-2",download:"https://connect.family.co/v0/download/ledger",android:"https://play.google.com/store/apps/details?id=com.ledger.live",ios:"https://apps.apple.com/app/ledger-live-web3-wallet/id1361671700"},createUri:e=>isAndroid()?e:`ledgerlive://wc?uri=${encodeURIComponent(e)}`}),imToken=()=>({id:"imToken",name:"imToken",logos:{default:(0,y.jsx)(J.ImToken,{})},logoBackground:"#098de6",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/imToken",android:"https://play.google.com/store/apps/details?id=im.token.app",ios:"https://itunes.apple.com/us/app/imtoken2/id1384798940"},createUri:e=>`imtokenv2://wc?uri=${encodeURIComponent(e)}`}),brave=()=>{var e;let o="undefined"!=typeof window&&(null===(e=window.ethereum)||void 0===e?void 0:e.isBraveWallet)===!0;return{id:"brave",name:"Brave Wallet",shortName:"Brave",logos:{default:(0,y.jsx)(J.Brave,{})},logoBackground:"#fff",scannable:!1,downloadUrls:{},installed:o,createUri:e=>e}},steak=()=>({id:"steak",name:"Steak",logos:{default:(0,y.jsx)(J.Steak,{})},logoBackground:"#000000",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/steak",android:"https://play.google.com/store/apps/details?id=fi.steakwallet.app",ios:"https://apps.apple.com/app/steakwallet/id1569375204",website:"https://steakwallet.fi/download"},createUri:e=>isAndroid()?e:`https://links.steakwallet.fi/wc?uri=${encodeURIComponent(e)}`}),unstoppable=()=>({id:"unstoppable",name:"Unstoppable",logos:{default:(0,y.jsx)(J.Unstoppable,{})},logoBackground:"linear-gradient(180deg, #FED812 0%, #FFAF00 100%)",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/unstoppable",ios:"https://apps.apple.com/app/bank-bitcoin-wallet/id1447619907",android:"https://play.google.com/store/apps/details?id=io.horizontalsystems.bankwallet"},createUri:e=>isAndroid()?e:`https://unstoppable.money/wc?uri=${encodeURIComponent(e)}`}),onto=()=>({id:"onto",name:"ONTO",logos:{default:(0,y.jsx)(J.ONTO,{})},logoBackground:"#ffffff",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/onto",ios:"https://apps.apple.com/app/onto-an-ontology-dapp/id1436009823",android:"https://play.google.com/store/apps/details?id=com.github.ontio.onto",website:"https://onto.app/en/download/"},createUri:e=>isAndroid()?e:`https://onto.app/wc?uri=${encodeURIComponent(e)}`}),gnosisSafe=()=>({id:"gnosisSafe",name:"Gnosis Safe",shortName:"Safe",logos:{default:(0,y.jsx)(J.GnosisSafe,{})},logoBackground:"#ffffff",scannable:!1,installed:"undefined"!=typeof window&&(null==window?void 0:window.parent)!==window,downloadUrls:{download:"https://connect.family.co/v0/download/gnosisSafe",ios:"https://apps.apple.com/app/id1515759131",android:"https://play.google.com/store/apps/details?id=io.gnosis.safe",website:"https://gnosis-safe.io/"},createUri:e=>isAndroid()?e:`https://gnosis-safe.io/wc?uri=${encodeURIComponent(e)}`}),frontier=()=>{let e=isFrontier();return{id:"frontier",name:"Frontier Wallet",logos:{default:(0,y.jsx)(J.Frontier,{})},shortName:"Frontier",logoBackground:"#CC703C",scannable:!1,installed:e,downloadUrls:{download:"https://connect.family.co/v0/download/frontier",ios:"https://apps.apple.com/app/frontier-crypto-defi-wallet/id1482380988",android:"https://play.google.com/store/apps/details?id=com.frontierwallet",website:"https://frontier.xyz/",chrome:"https://chrome.google.com/webstore/detail/frontier-wallet/kppfdiipphfccemcignhifpjkapfbihd"},createUri:e=>isAndroid()?e:`frontier://wc?uri=${encodeURIComponent(e)}`}},zerion=()=>({id:"zerion",name:"Zerion",logos:{default:(0,y.jsx)(J.Zerion,{})},logoBackground:"#CC703C",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/zerion",ios:"https://apps.apple.com/app/apple-store/id1456732565",android:"https://play.google.com/store/apps/details?id=io.zerion.android",website:"https://zerion.io/"},createUri:e=>isAndroid()?e:`https://app.zerion.io/wc?uri=${encodeURIComponent(e)}`}),family=()=>{let e=isFamily();return{id:"family",name:"Family",logos:{default:(0,y.jsx)(J.Family,{}),transparent:(0,y.jsx)(J.Family,{transparent:!0})},logoBackground:"#7DC4FF",installed:!!e||void 0,scannable:!0,downloadUrls:{download:"https://connect.family.co/v0/download/family",ios:"https://family.co/download",website:"https://family.co"},createUri:e=>isAndroid()?e:`familywallet://wc?uri=${encodeURIComponent(e)}`}},frame=()=>{let e=isFrame();return{id:"frame",name:"Frame",logos:{default:(0,y.jsx)(J.Frame,{}),transparent:(0,y.jsx)(J.Frame,{}),appIcon:(0,y.jsx)(J.Frame,{}),connectorButton:(0,y.jsx)(J.Frame,{})},logoBackground:"#fff",scannable:!1,downloadUrls:{download:"https://connect.family.co/v0/download/frame",website:"https://frame.sh",chrome:"https://chrome.google.com/webstore/detail/frame-companion/ldcoohedfbjoobcadoglnnmmfbdlmmhf",firefox:"https://addons.mozilla.org/en-US/firefox/addon/frame-extension",brave:"https://chrome.google.com/webstore/detail/frame-companion/ldcoohedfbjoobcadoglnnmmfbdlmmhf"},installed:e,createUri:e=>e}},phantom=()=>{let e=isPhantom();return{id:"phantom",name:"Phantom",shortName:"Phantom",scannable:!1,logos:{default:(0,y.jsx)(J.Phantom,{background:!0}),transparent:(0,y.jsx)(J.Phantom,{})},installed:!!e}},dawn=()=>{let e=isDawn();return{id:"dawn",name:"Dawn Wallet",shortName:"Dawn",logos:{default:(0,y.jsx)(J.Dawn,{})},logoBackground:"#000000",scannable:!1,installed:!!e,downloadUrls:{download:"https://apps.apple.com/us/app/dawn-ethereum-wallet/id1673143782",website:"https://www.dawnwallet.xyz/",ios:"https://apps.apple.com/us/app/dawn-ethereum-wallet/id1673143782"}}},rabby=()=>{let e=isRabby();return{id:"rabby",name:"Rabby Wallet",logos:{default:(0,y.jsx)(J.Rabby,{}),transparent:(0,y.jsx)(J.Rabby,{}),appIcon:(0,y.jsx)(J.Rabby,{}),connectorButton:(0,y.jsx)(J.Rabby,{})},logoBackground:"#8697FF",scannable:!1,downloadUrls:{website:"https://rabby.io",chrome:"https://chrome.google.com/webstore/detail/rabby-wallet/acmacodkjbdgmoleebolmdjonilkdbch"},installed:e}},fordefi=()=>{let e=isFordefi();return{id:"fordefi",name:"Fordefi",logos:{default:(0,y.jsx)(J.Fordefi,{})},logoBackground:"#ffffff",scannable:!1,downloadUrls:{},installed:e}},tokenPocket=()=>{let e=isTokenPocket();return{id:"tokenPocket",name:"TokenPocket Wallet",logos:{default:(0,y.jsx)(J.TokenPocket,{})},logoBackground:"#2980FE",scannable:!1,downloadUrls:{website:"https://www.tokenpocket.pro/en/download/app",download:"https://www.tokenpocket.pro/en/download/app",android:"https://play.google.com/store/apps/details?id=vip.mytokenpocket",ios:"https://apps.apple.com/us/app/tp-global-wallet/id6444625622",chrome:"https://chrome.google.com/webstore/detail/tokenpocket/mfgccjchihfkkindfppnaooecgfneiii"},installed:e}},talisman=()=>{let e=isTalisman();return{id:"talisman",name:"Talisman",shortName:"Talisman",scannable:!1,logos:{default:(0,y.jsx)(J.Talisman,{})},downloadUrls:{download:"https://talisman.xyz/download",website:"https://talisman.xyz",chrome:"https://chrome.google.com/webstore/detail/talisman-polkadot-wallet/fijngjgcjhjmmpcmkeiomlglpeiijkld",firefox:"https://addons.mozilla.org/en-US/firefox/addon/talisman-wallet-extension/"},installed:e}},getWallets=()=>[injected(),walletConnect(),metaMask(),infinityWallet(),coinbaseWallet(),argent(),trust(),ledger(),family(),imToken(),unstoppable(),onto(),steak(),frontier(),zerion(),brave(),gnosisSafe(),frame(),rainbow(),phantom(),dawn(),rabby(),fordefi(),tokenPocket(),talisman()];function useDefaultWallets(){let{connectors:e}=(0,l.$4)(),o=[];e.find(e=>"metaMask"===e.id)||o.push("metaMask"),e.find(e=>"coinbaseWallet"===e.id)||o.push("coinbaseWallet"),o.push("argent","trust","ledger","infinityWallet","family","imToken","rainbow","unstoppable","onto","steak","frontier","zerion","gnosisSafe","brave","frame","phantom","dawn","rabby","talisman","fordefi","tokenPocket");let t=getWallets();return t.filter(e=>o.includes(e.id))}function useConnectors(){let{connectors:e}=(0,l.$4)();return e}function useConnector(e){let o=useConnectors();return o.find(o=>o.id===e)}let useInjectedWallet=()=>{let e=useDefaultWallets(),o=useConnector("injected"),getInjectedNames=()=>{if(!o)return[];let e=o.name.split(/[(),]+/);return e.shift(),e=e.map(e=>e.trim()).filter(e=>""!==e).filter(e=>"Injected"!==e)},t=(()=>{var o,t,n,i,r;let a=e.filter(e=>e.installed);return a.length>0?a[0]:{id:"injected",name:null!==(t=null===(o=getInjectedNames())||void 0===o?void 0:o[0])&&void 0!==t?t:"Browser Wallet",shortName:null!==(r=null===(i=null===(n=getInjectedNames())||void 0===n?void 0:n[0])||void 0===i?void 0:i.replace(" Wallet",""))&&void 0!==r?r:"Browser",logos:{default:(0,y.jsx)(J.Injected,{})}}})();return{wallet:t,enabled:(()=>{if(!("undefined"!=typeof window&&(null==window?void 0:window.ethereum)))return!1;let e=getInjectedNames();return!(1===e.length&&("MetaMask"===e[0]||"Coinbase Wallet"===e[0])||2===e.length&&e.includes("MetaMask")&&e.includes("Coinbase Wallet"))})()&&null!==t}},ProfileIcon=({isSignedIn:e})=>(0,y.jsxs)("div",{style:{position:"relative"},children:[e?(0,y.jsx)(AuthIcon,{style:{bottom:-1,right:-1}}):(0,y.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,y.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,y.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,y.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,y.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),InfoIcon=({...e})=>(0,y.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,y.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),CloseIcon=({...e})=>(0,y.jsx)(E.E.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,y.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),BackIcon=({...e})=>(0,y.jsx)(E.E.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,y.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),eG={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},Modal=({open:e,pages:o,pageId:t,positionInside:n,inline:i,demo:r,onClose:a,onBack:s,onInfo:d})=>{var c,p,u,h,x,g,b;let C;let f=useContext(),m=useThemeContext(),v=isMobile(),{isSignedIn:k,reset:w}=useSIWE(),L=useDefaultWallets(),S=L.filter(e=>e.installed),I=q.find(e=>e.id===f.connector),F=useInjectedWallet();if(isInjectedConnector(f.connector)){let e=F.enabled?F.wallet:S[0];I={...e,extensionIsInstalled:()=>null==e?void 0:e.installed,extensions:{...null==e?void 0:e.downloadUrls},appUrls:{...null==e?void 0:e.downloadUrls}}}let N=useLocales({CONNECTORNAME:null==I?void 0:I.name}),[A,O]=(0,B.Y)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),W=!("exited"===A||"unmounted"===A),D="preEnter"===A||"exiting"!==A,z=f.route===nt.CONNECTORS?0:f.route===nt.DOWNLOAD?2:1,T=usePrevious(z,z);n||useLockBodyScroll(W),usePrevious(t,t),(0,j.useEffect)(()=>{O(e),e&&H(void 0)},[e]);let[R,Z]=(0,j.useState)({width:void 0,height:void 0}),[_,H]=(0,j.useState)(void 0),updateBounds=e=>{let o={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};Z({width:`${null==o?void 0:o.width}px`,height:`${null==o?void 0:o.height}px`})},U=(0,j.useCallback)(e=>{e&&(P.current=e,H(void 0!==_),clearTimeout(C),C=setTimeout(()=>H(!1),360),updateBounds(e))},[e,_]),{chain:G}=(0,l.LN)(),{switchNetwork:V}=(0,l.g0)(),P=(0,j.useRef)(null);(0,j.useEffect)(()=>{P.current&&updateBounds(P.current)},[G,V,v,k,f.options,f.resize]),(0,j.useEffect)(()=>{if(!W){Z({width:void 0,height:void 0});return}let listener=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",listener),()=>{document.removeEventListener("keydown",listener)}},[W,a]);let Y={"--height":R.height,"--width":R.width},J=(0,y.jsx)(Q,{$useTheme:null!==(c=null==r?void 0:r.theme)&&void 0!==c?c:m.theme,$useMode:null!==(p=null==r?void 0:r.mode)&&void 0!==p?p:m.mode,$customTheme:null!==(u=null==r?void 0:r.customTheme)&&void 0!==u?u:m.customTheme,children:(0,y.jsxs)(ej,{role:"dialog",style:{pointerEvents:D?"auto":"none",position:n?"absolute":void 0},children:[!i&&(0,y.jsx)(ex,{$active:D,onClick:a,$blur:null===(h=f.options)||void 0===h?void 0:h.overlayBlur}),(0,y.jsxs)(eI,{style:Y,initial:!1,children:[(0,y.jsx)("div",{style:{pointerEvents:_?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,y.jsxs)(em,{className:`${D&&"active"}`,children:[(0,y.jsx)(M.M,{initial:!1,children:(null===(x=f.options)||void 0===x?void 0:x.disclaimer)&&f.route===nt.CONNECTORS&&(0,y.jsx)(eN,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,y.jsx)(eF,{children:(0,y.jsx)("div",{children:null===(g=f.options)||void 0===g?void 0:g.disclaimer})})})}),(0,y.jsx)(M.M,{initial:!1,children:f.errorMessage&&(0,y.jsxs)(ee,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,y.jsx)("span",{children:f.errorMessage}),(0,y.jsx)("div",{onClick:()=>f.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,y.jsx)(CloseIcon,{})})]})}),(0,y.jsxs)(ev,{children:[a&&(0,y.jsx)(eL,{"aria-label":flattenChildren(N.close).toString(),onClick:a,children:(0,y.jsx)(CloseIcon,{})}),(0,y.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,y.jsx)(M.M,{children:s?(0,y.jsx)(eM,{disabled:_,"aria-label":flattenChildren(N.back).toString(),onClick:s,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:v?0:.1,delay:v?.01:0},children:(0,y.jsx)(BackIcon,{})},"backButton"):f.route===nt.PROFILE&&f.signInWithEthereum?(0,y.jsxs)(y.Fragment,{children:[!k&&(0,y.jsx)(E.E.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:v?0:.1}},children:(0,y.jsx)(eA,{children:N.signInWithEthereumScreen_tooltip})}),(0,y.jsx)(eE,{disabled:_,"aria-label":N.signInWithEthereumScreen_signedOut_heading,onClick:()=>{w(),f.setRoute(nt.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:v?0:.1,delay:v?.01:0},children:(0,y.jsx)(ProfileIcon,{isSignedIn:k})},"siweButton")]}):d&&!(null===(b=f.options)||void 0===b?void 0:b.hideQuestionMarkCTA)&&(0,y.jsx)(eS,{disabled:_,"aria-label":flattenChildren(N.moreInformation).toString(),onClick:d,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:v?0:.1,delay:v?.01:0},children:(0,y.jsx)(InfoIcon,{})},"infoButton")})})]}),(0,y.jsx)(ed,{children:(0,y.jsx)(M.M,{children:(0,y.jsx)(E.E.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:v?0:.17,delay:v?.01:0},children:(0,y.jsx)(FitText,{children:function(){switch(f.route){case nt.ABOUT:return N.aboutScreen_heading;case nt.CONNECT:if(function(){let e=q.filter(e=>e.id===f.connector)[0];if(!e)return!1;let o=e.extensionIsInstalled&&e.extensionIsInstalled(),t=!e.scannable||o;return!t}())return isWalletConnectConnector(null==I?void 0:I.id)?N.scanScreen_heading:N.scanScreen_heading_withConnector;return null==I?void 0:I.name;case nt.CONNECTORS:return N.connectorsScreen_heading;case nt.MOBILECONNECTORS:return N.mobileConnectorsScreen_heading;case nt.DOWNLOAD:return N.downloadAppScreen_heading;case nt.ONBOARDING:return N.onboardingScreen_heading;case nt.PROFILE:return N.profileScreen_heading;case nt.SWITCHNETWORKS:return N.switchNetworkScreen_heading;case nt.SIGNINWITHETHEREUM:return k?N.signInWithEthereumScreen_signedIn_heading:N.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${f.route}-${k?"signedIn":""}`)})}),(0,y.jsx)(ek,{children:Object.keys(o).map(e=>{let i=o[e];return(0,y.jsx)(Page,{open:e===t,initial:!n&&"entered"!==A,enterAnim:e===t?z>T?"active-scale-up":"active":"",exitAnim:e!==t?z<T?"exit-scale-down":"exit":"",children:(0,y.jsx)(ey,{ref:U,style:{pointerEvents:e===t&&D?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,y.jsx)(y.Fragment,{children:W&&(0,y.jsx)(y.Fragment,{children:n?J:(0,y.jsx)(y.Fragment,{children:(0,y.jsx)(Portal,{children:(0,y.jsx)(FocusTrap,{children:J})})})})})},Page=({children:e,open:o,initial:t,prevDepth:n,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[s,l]=(0,B.Y)({timeout:400,preEnter:!0,initialEntered:o,mountOnEnter:!0,unmountOnExit:!0});return((0,j.useEffect)(()=>{l(o)},[o]),"exited"===s||"unmounted"===s)?null:(0,y.jsx)(ew,{className:`${"preEnter"===s||"exiting"!==s?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},OrDivider=({children:e})=>{let o=useLocales();return(0,y.jsx)(el,{children:(0,y.jsx)("span",{children:null!=e?e:o.or})})},eV=R(E.E.div)`
  position: relative;
...
`,eQ=R(E.E.div)`
  ...
  animation: ${eY} 1000ms 100ms ease both;
  @media only screen and (max-width: ${$.mobileWidth}px) {
    animation: none;
  }
`,eJ=I.F4`
...
`,e3=R(E.E.div)`
  ...
  animation: ${eJ} 750ms cubic-bezier(0.19, 1, 0.22, 1) both;
  ...
  &:nth-child(1){ ${e2}{ animation-delay:0ms; } }
  &:nth-child(2){ ${e2}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${e2}{ animation-delay:-1200ms; } }
  &:nth-child(4){ ${e2}{ animation-delay:-1800ms; } }
  &:nth-child(5){ ${e2}{ animation-delay:-2400ms; } }

  &:nth-child(1){ ${e1}{ animation-delay:-200ms; } }
  &:nth-child(2){ ${e1}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${e1}{ animation-delay:-800ms; } }
  &:nth-child(4){ ${e1}{ animation-delay:-300ms; } }
  &:nth-child(5){ ${e1}{ animation-delay:-3200ms; } }
...
`,ot=R.button`
  ...
  @media only screen and (min-width: ${$.mobileWidth+1}px) {
    &:hover,
    &:focus-visible {
...
`,oa=R(E.E.div)`
  ...
  svg {
    display: block;
    position: relative;
    animation: ${or} 1s ease-in-out infinite;
  }
`,os={duration:.4,ease:[.175,.885,.32,.98]},Spinner$3=()=>(0,y.jsx)(oa,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...os}},transition:{...os,delay:.2},children:(0,y.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,y.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),ol={duration:.4,ease:[.175,.885,.32,.98]},Button=({children:e,variant:o="secondary",disabled:t,icon:n,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:s,download:l,href:d,style:c,onClick:p})=>{let u="string"==typeof e?e:flattenChildren(e).join(""),h="string"==typeof d?d:flattenChildren(d).join("");return(0,y.jsx)(ot,{as:d?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:h,target:d&&"_blank",rel:d&&"noopener noreferrer",disabled:t,$variant:o,style:c,children:(0,y.jsxs)(M.M,{initial:!1,children:[(0,y.jsxs)(oo,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...ol}},transition:{...ol,delay:.2},children:[n&&"left"===i&&(0,y.jsx)(oi,{$rounded:r,children:n}),l&&(0,y.jsx)(e7,{children:(0,y.jsx)(oe,{children:(0,y.jsxs)(e9,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)(e8,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,y.jsx)(e6,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,y.jsx)(on,{style:{paddingLeft:s?6:0},children:(0,y.jsx)(FitText,{children:e})}),n&&"right"===i&&(0,y.jsx)(oi,{$rounded:r,children:n}),s&&(0,y.jsxs)(e9,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)(e8,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,y.jsx)(e6,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},u),a&&(0,y.jsx)(e4,{children:(0,y.jsx)(Spinner$3,{})})]})})},Introduction=()=>{var e,o;let t=useContext(),n=useLocales({}),i=null!==(o=null===(e=t.options)||void 0===e?void 0:e.walletOnboardingUrl)&&void 0!==o?o:n.onboardingScreen_ctaUrl;return(0,y.jsxs)(es,{children:[(0,y.jsxs)(eV,{children:[(0,y.jsxs)(eP,{children:[(0,y.jsx)(e3,{children:(0,y.jsx)(eX,{children:(0,y.jsx)(eq,{children:(0,y.jsx)(e1,{children:(0,y.jsx)(e2,{children:(0,y.jsx)(eK,{children:(0,y.jsx)(J.Coinbase,{background:!0})})})})})})}),(0,y.jsx)(e3,{children:(0,y.jsx)(eX,{children:(0,y.jsx)(eq,{children:(0,y.jsx)(e1,{children:(0,y.jsx)(e2,{children:(0,y.jsx)(eK,{children:(0,y.jsx)(J.MetaMask,{background:!0})})})})})})}),(0,y.jsx)(e3,{children:(0,y.jsx)(eX,{children:(0,y.jsx)(eq,{children:(0,y.jsx)(e1,{children:(0,y.jsx)(e2,{children:(0,y.jsx)(eK,{children:(0,y.jsx)(J.Trust,{})})})})})})}),(0,y.jsx)(e3,{children:(0,y.jsx)(eX,{children:(0,y.jsx)(eq,{children:(0,y.jsx)(e1,{children:(0,y.jsx)(e2,{children:(0,y.jsx)(eK,{children:(0,y.jsx)(J.Argent,{})})})})})})}),(0,y.jsx)(e3,{children:(0,y.jsx)(eX,{children:(0,y.jsx)(eq,{children:(0,y.jsx)(e1,{children:(0,y.jsx)(e2,{children:(0,y.jsx)(eK,{children:(0,y.jsx)(J.ImToken,{})})})})})})})]}),(0,y.jsx)(eQ,{children:e5})]}),(0,y.jsxs)(ep,{style:{paddingBottom:18},children:[(0,y.jsx)(eu,{$small:!0,children:n.onboardingScreen_h1}),(0,y.jsx)(eh,{children:n.onboardingScreen_p})]}),(0,y.jsx)(Button,{href:i,arrow:!0,children:n.onboardingScreen_ctaText})]})},od=R.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,ob=R.button`
  ...
  ${e=>e.$active?I.iv`
        ...
        `}
`,oC={scale:[.9,1.25,1.6],opacity:[0,.11,0]},of={ease:"linear",duration:2,repeat:1/0},om=R.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,ok=R(E.E.div)`
  ...
  overflow: hidden;
  border-radius: 100%;
  animation: ${ov} 16s linear infinite;
`,ow=R(E.E.div)`
  overflow: hidden;
...
`;function useWalletConnectUri({enabled:e}={enabled:!0}){var o;let{log:t}=useContext(),[n,i]=(0,j.useState)(void 0),r=null!==(o=useConnector("walletConnect"))&&void 0!==o?o:useConnector("walletConnectLegacy"),a=(null==r?void 0:r.id)==="walletConnectLegacy",{isConnected:s}=(0,l.mA)(),{connectAsync:d}=useConnect();return(0,j.useEffect)(()=>{if(e&&r&&!n&&r&&!s)return connectWalletConnect(r),t("add wc listeners"),r.on("message",handleMessage),r.on("change",handleChange),r.on("connect",handleConnect),r.on("disconnect",handleDisconnect),r.on("error",handleError),()=>{t("remove wc listeners"),r.off("message",handleMessage),r.off("change",handleChange),r.off("connect",handleConnect),r.off("disconnect",handleDisconnect),r.off("error",handleError)};async function handleMessage({type:e,data:o}){if(t("WC Message",e,o),a){if(t("isWalletConnectLegacy"),"connecting"===e){let e=await r.getProvider();i(e.connector.uri),e.connector.on("disconnect",()=>{t("User rejected, regenerate QR code"),connectWalletConnect(r)})}}else"display_uri"===e&&i(o)}async function handleChange(e){t("WC Change",e)}async function handleDisconnect(){var e;t("WC Disconnect"),r&&(null===(e=r.options)||void 0===e?void 0:e.version)==="1"&&connectWallet(r)}async function handleConnect(){t("WC Connect")}async function handleError(e){t("WC Error",e)}async function connectWallet(e){let o=await d({connector:e});return!!o&&o}async function connectWalletConnect(e){try{await connectWallet(e)}catch(o){t("catch error"),t(o),o.code?4001===o.code?(t("error.code - User rejected"),connectWalletConnect(e)):t("error.code - Unknown Error"):t("WalletConnect cannot connect.",o)}}},[e,r,s]),{uri:n}}let oU=R(E.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
  pointer-events: none;
...
`,Tooltip=({children:e,message:o,open:t,xOffset:n=0,yOffset:i=0,delay:r})=>{var a;let s=useContext(),l=useThemeContext();if(null===(a=s.options)||void 0===a?void 0:a.hideTooltips)return(0,y.jsx)(y.Fragment,{children:e});let[d,c]=(0,j.useState)(!1),[p,u]=(0,j.useState)(!1),[h,x]=(0,j.useState)("small"),[g,b]=(0,j.useState)(!1),[C]=(0,j.useState)(s.route),f=(0,j.useRef)(null),[m,v]=(0,A.Z)({debounce:g?0:220,offsetSize:!0,scroll:!0}),checkBounds=()=>{let e=!1,o=n+v.left+v.width,t=i+v.top+.5*v.height;return(o>window.innerWidth||o<0||t>window.innerHeight||t<0)&&(e=!0),e},k="undefined"!=typeof window?j.useLayoutEffect:j.useEffect;return k(()=>{if(!f.current||v.top+v.bottom+v.left+v.right+v.height+v.width===0)return;let e=n+v.left+v.width,o=i+v.top+.5*v.height;g||0===e||0===o||b(!0),f.current.style.left=`${e}px`,f.current.style.top=`${o}px`,x(f.current.offsetHeight<=40?"small":"large"),u(checkBounds())},[v,t,d]),(0,j.useEffect)(()=>{s.open||c(!1)},[s.open]),(0,j.useEffect)(()=>{c(!!t)},[t]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(E.E.div,{ref:m,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>c(!0),onHoverEnd:()=>c(!1),onClick:()=>c(!1),children:e}),(0,y.jsx)(Portal,{children:(0,y.jsx)(M.M,{children:C===s.route&&!p&&d&&(0,y.jsx)(Q,{$useTheme:l.theme,$useMode:l.mode,$customTheme:l.customTheme,children:(0,y.jsx)(oU,{children:(0,y.jsxs)(oG,{role:"tooltip",$size:h,ref:f,initial:"collapsed",animate:g?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[o,(0,y.jsx)(oV,{$size:h})]})})})})})]})},Wallets=()=>{var e,o,t,n,i,r,a;let s=useContext(),l=useLocales({}),d=isMobile(),c=useInjectedWallet(),{uri:p}=useWalletConnectUri({enabled:d}),{connectAsync:u,connectors:h}=useConnect(),{lastConnectorId:x}=useLastConnector(),openDefaultConnect=async e=>{if(isMetaMaskConnector(e.id)&&d){let e=isAndroid()?p:`https://metamask.app.link/wc?uri=${encodeURIComponent(p)}`;e&&(window.location.href=e)}else try{await u({connector:e})}catch(e){s.displayError("Async connect error. See console for more details.",e)}};return(0,j.useEffect)(()=>{},[d]),(0,y.jsx)(es,{style:{width:312},children:d?(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(oR,{children:h.map(e=>{var o,t,n,i,r,a,d,p;let u=q.filter(o=>o.id===e.id)[0];if(!u)return null;let h=u.logos,x=null!==(t=null!==(o=u.shortName)&&void 0!==o?o:u.name)&&void 0!==t?t:e.name;if(isInjectedConnector(u.id)){if(!c.enabled)return null;c.wallet&&(h=c.wallet.logos,x=null!==(n=c.wallet.shortName)&&void 0!==n?n:c.wallet.name)}return isWalletConnectConnector(u.id)&&(x=null!==(r=null===(i=s.options)||void 0===i?void 0:i.walletConnectName)&&void 0!==r?r:l.otherWallets),(0,y.jsxs)(oZ,{disabled:s.route!==nt.CONNECTORS,onClick:()=>{isInjectedConnector(u.id)||isMetaMaskConnector(u.id)&&isMetaMask()?(s.setRoute(nt.CONNECT),s.setConnector(e.id)):isWalletConnectConnector(e.id)?s.setRoute(nt.MOBILECONNECTORS):openDefaultConnect(e)},children:[(0,y.jsx)(oH,{children:null!==(p=null!==(d=null!==(a=h.mobile)&&void 0!==a?a:h.appIcon)&&void 0!==d?d:h.connectorButton)&&void 0!==p?p:h.default}),(0,y.jsx)(o_,{children:x})]},`m-${e.id}`)})}),(0,y.jsxs)(oF,{children:[(0,y.jsxs)(ep,{style:{padding:0,textAlign:"left"},children:[(0,y.jsx)(eu,{$small:!0,children:l.connectorsScreen_h1}),(0,y.jsx)(eh,{children:l.connectorsScreen_p})]}),(0,y.jsxs)(oN,{children:[!(null===(e=s.options)||void 0===e?void 0:e.hideQuestionMarkCTA)&&(0,y.jsx)(Button,{variant:"tertiary",onClick:()=>s.setRoute(nt.ABOUT),children:l.learnMore}),!(null===(o=s.options)||void 0===o?void 0:o.hideNoWalletCTA)&&(0,y.jsx)(Button,{variant:"tertiary",onClick:()=>s.setRoute(nt.ONBOARDING),children:l.getWallet})]})]}),(null===(t=s.options)||void 0===t?void 0:t.disclaimer)&&(0,y.jsx)(eF,{style:{visibility:"hidden",pointerEvents:"none"},children:(0,y.jsx)("div",{children:null===(n=s.options)||void 0===n?void 0:n.disclaimer})})]}):(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(oW,{children:h.map(e=>{var o,t,n,i,r,a;let d=q.filter(o=>o.id===e.id)[0];if(!d)return null;let p=d.logos,u=null!==(o=d.name)&&void 0!==o?o:e.name;if(isWalletConnectConnector(d.id)&&(u=null!==(n=null===(t=s.options)||void 0===t?void 0:t.walletConnectName)&&void 0!==n?n:l.otherWallets),isInjectedConnector(d.id)){if(!c.enabled)return null;c.wallet&&(p=c.wallet.logos,u=c.wallet.name)}let h=null!==(i=p.connectorButton)&&void 0!==i?i:p.default;return(d.extensionIsInstalled&&p.appIcon&&d.extensionIsInstalled()&&(h=p.appIcon),!e.ready&&c.enabled)?(0,y.jsx)(Tooltip,{xOffset:18,message:(0,y.jsxs)("div",{style:{width:230,padding:"6px 4px"},children:[u," Unavailable as ",c.wallet.name," is installed. Disable ",c.wallet.name," to connect with ",u,"."]}),delay:0,children:(0,y.jsxs)(oB,{disabled:!0,children:[(0,y.jsx)(oT,{children:h}),(0,y.jsxs)(oz,{children:[u,!(null===(r=s.options)||void 0===r?void 0:r.hideRecentBadge)&&x===e.id&&(0,y.jsx)(oD,{children:(0,y.jsx)("span",{children:"Recent"})})]})]})},e.id):(0,y.jsxs)(oB,{disabled:s.route!==nt.CONNECTORS,onClick:()=>{s.setRoute(nt.CONNECT),s.setConnector(e.id)},children:[(0,y.jsx)(oT,{children:h}),(0,y.jsxs)(oz,{children:[u,!(null===(a=s.options)||void 0===a?void 0:a.hideRecentBadge)&&x===e.id&&(0,y.jsx)(oD,{children:(0,y.jsx)("span",{children:"Recent"})})]})]},e.id)})}),!(null===(i=s.options)||void 0===i?void 0:i.hideNoWalletCTA)&&(0,y.jsx)(oA,{children:(0,y.jsxs)(oO,{onClick:()=>s.setRoute(nt.ONBOARDING),children:[(0,y.jsx)(WalletIcon$1,{})," ",l.connectorsScreen_newcomer]})}),(null===(r=s.options)||void 0===r?void 0:r.disclaimer)&&(0,y.jsx)(eF,{style:{visibility:"hidden",pointerEvents:"none"},children:(0,y.jsx)("div",{children:null===(a=s.options)||void 0===a?void 0:a.disclaimer})})]})})},oP=R.div`
  text-align: center;
...
`,oX=R.div`
  ...
  ${e=>e.$disabled&&I.iv`
    ...
    `}
`,oq=R.div``;function useWalletConnectModal(){let{log:e}=useContext(),{connectAsync:o,connectors:t}=useConnect(),[n,i]=(0,j.useState)(!1);return{isOpen:n,open:async()=>{let n=document.createElement("style");n.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(n);let r=t.find(e=>isWalletConnectConnector(e.id));if(r){let t;t="walletConnectLegacy"===r.id?new m.O({...r,options:{...r.options,qrcode:!0}}):new f.z({...r,options:{...r.options,showQrModal:!0}}),i(!0);try{await o({connector:t})}catch(o){e("WalletConnect",o)}i(!1),document.head.removeChild(n)}else e("No WalletConnect connector available")}}}let oK=R(E.E.div)`
  ...
  ${e=>e.$clipboard?I.iv`
        ...
        `}
`,CopyToClipboardIcon=({copied:e,small:o})=>(0,y.jsx)(oK,{$clipboard:e,children:(0,y.jsx)(CopyToClipboardIcon$1,{style:{transform:o?"scale(1)":"translateX(3px) scale(1.5)",opacity:o||e?1:.3}})}),o$=R.div`
...
`,CopyToClipboard=({string:e,children:o,variant:t})=>{let n;let[i,r]=(0,j.useState)(!1),onCopy=()=>{if(!e)return;let o=e.trim();navigator.clipboard&&navigator.clipboard.writeText(o),r(!0),clearTimeout(n),n=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,y.jsx)(Button,{disabled:!e,onClick:onCopy,icon:(0,y.jsx)(CopyToClipboardIcon,{copied:i}),children:o}):(0,y.jsx)(o$,{onClick:onCopy,$disabled:!e,children:(0,y.jsxs)(o1,{children:[o,(0,y.jsx)(CopyToClipboardIcon,{copied:i,small:!0})]})})},o0=(0,y.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,y.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),MobileConnectors=()=>{var e;let o=useContext(),t=useLocales(),{uri:n}=useWalletConnectUri(),{open:i,isOpen:r}=useWalletConnectModal(),a=useDefaultWallets().filter(e=>void 0===e.installed&&!isWalletConnectConnector(e.id)),connectWallet=e=>{var t;if(e.installed)o.setRoute(nt.CONNECT),o.setConnector(e.id);else{let o=null===(t=e.createUri)||void 0===t?void 0:t.call(e,n);o&&(window.location.href=o)}};return(0,y.jsx)(es,{style:{width:312},children:(0,y.jsxs)(oq,{children:[(0,y.jsx)(ep,{children:(0,y.jsxs)(oX,{$disabled:!n,children:[a.map((e,o)=>{var t;let{name:n,shortName:i,logos:r,logoBackground:a}=e;return(0,y.jsxs)(oP,{onClick:()=>connectWallet(e),style:{animationDelay:`${50*o}ms`},children:[(0,y.jsx)(oY,{$outline:!0,style:a?{background:a}:void 0,children:null!==(t=r.mobile)&&void 0!==t?t:r.default}),(0,y.jsx)(oQ,{children:null!=i?i:n})]},o)}),(0,y.jsxs)(oP,{onClick:i,$waiting:r,children:[(0,y.jsx)(oY,{style:{background:"var(--ck-body-background-secondary)"},children:r?(0,y.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,y.jsx)("div",{style:{width:"50%"},children:(0,y.jsx)(Spinner$3,{})})}):o0}),(0,y.jsx)(oQ,{children:t.more})]})]})}),(null===(e=o.options)||void 0===e?void 0:e.walletConnectCTA)!=="modal"&&(0,y.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:16},children:(0,y.jsx)(CopyToClipboard,{variant:"button",string:n,children:t.copyToClipboard})})]})})},o2=R(E.E.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,o6=R(E.E.div)`
  ...
  ${e=>e.$shake&&I.iv`
      animation: ${o3} 220ms ease-out both;
      &:before {
        animation: ${o5} 220ms ease-out 750ms both;
      }
    `}
`,o8=R(E.E.button)`
  z-index: 5;
...
`,Alert=({children:e,icon:o})=>(0,y.jsxs)(te,{children:[o&&(0,y.jsx)(to,{children:o}),(0,y.jsx)("div",{children:e})]});Alert.displayName="Alert";let tt=R(E.E.div)`
  z-index: 4;
  position: relative;
  width: 100px;
  height: 100px;
...
`,tf=R(E.E.div)`
  ...
  &:after {
    ...
    animation: ${tC} 1000ms linear infinite both;
  }
`,tm=R(E.E.div)`
  z-index: 6;
  position: absolute;
...
`,tv=R(E.E.div)`
  ...
  ${e=>e.$wcLogo?I.iv`
        ...
        `}
`,generateMatrix=(e,o)=>{let t=Array.prototype.slice.call(W.create(e,{errorCorrectionLevel:o}).modules.data,0),n=Math.sqrt(t.length);return t.reduce((e,o,t)=>(t%n==0?e.push([o]):e[e.length-1].push(o))&&e,[])};function QRCode({ecl:e="M",size:o=200,uri:t,clearArea:n=!1,image:i,imageBackground:r="transparent"}){let a=n?76:0,s=o-20,l=(0,j.useMemo)(()=>{let o=[],n=generateMatrix(t,e),l=s/n.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(n.length-7)*l*e,r=(n.length-7)*l*t;for(let n=0;n<3;n++)o.push((0,y.jsx)("rect",{fill:n%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((n-2)*5)+(0===n?2:3),ry:-((n-2)*5)+(0===n?2:3),width:l*(7-2*n),height:l*(7-2*n),x:i+l*n,y:r+l*n},`${n}-${e}-${t}`))}),i){let e=(n.length-7)*l*1,t=(n.length-7)*l*1;o.push((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)("rect",{fill:r,rx:12,ry:12,width:7*l,height:7*l,x:e+0*l,y:t+0*l}),(0,y.jsx)("foreignObject",{width:7*l,height:7*l,x:e+0*l,y:t+0*l,children:(0,y.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let d=Math.floor((a+25)/l),c=n.length/2-d/2,p=n.length/2+d/2-1;return n.forEach((e,t)=>{e.forEach((e,r)=>{n[t][r]&&!(t<7&&r<7||t>n.length-8&&r<7||t<7&&r>n.length-8)&&(i||!(t>c&&t<p&&r>c&&r<p))&&o.push((0,y.jsx)("circle",{cx:t*l+l/2,cy:r*l+l/2,fill:"var(--ck-qr-dot-color)",r:l/3},`circle-${t}-${r}`))})}),o},[e,s,t]);return(0,y.jsxs)("svg",{height:s,width:s,viewBox:`0 0 ${s} ${s}`,style:{width:s,height:s},children:[(0,y.jsx)("rect",{fill:"transparent",height:s,width:s}),l]})}function CustomQRCode({value:e,image:o,imageBackground:t,imagePosition:n="center",tooltipMessage:i}){let r=function(){let[e,o]=(0,j.useState)({width:0,height:0});return(0,j.useEffect)(()=>{function handleResize(){o({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",handleResize),handleResize(),()=>window.removeEventListener("resize",handleResize)},[]),e}(),a=r.width>920&&i?(0,y.jsx)(Tooltip,{xOffset:139,yOffset:5,delay:.1,message:i,children:o}):o;return(0,y.jsx)(tg,{children:(0,y.jsxs)(tb,{children:[o&&(0,y.jsx)(tm,{children:(0,y.jsx)(tv,{$wcLogo:"center"!==n,style:{background:"center"===n?t:void 0},children:a})}),(0,y.jsx)(M.M,{initial:!1,children:e?(0,y.jsx)(E.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,y.jsx)(QRCode,{uri:e,size:288,ecl:"M",clearArea:!!("center"===n&&o)})},e):(0,y.jsxs)(tf,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,y.jsx)("span",{}),(0,y.jsx)("span",{}),(0,y.jsx)("span",{}),(0,y.jsx)("div",{})]})})]})})}CustomQRCode.displayName="CustomQRCode";let tk=R(E.E.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,ScanIconWithLogos=({logo:e})=>{let o=[(0,y.jsx)(J.MetaMask,{background:!0}),(0,y.jsx)(J.Coinbase,{background:!0}),(0,y.jsx)(J.Crypto,{}),(0,y.jsx)(J.ImToken,{}),(0,y.jsx)(J.Argent,{}),(0,y.jsx)(J.Trust,{})];return(0,y.jsx)(tk,{children:(0,y.jsxs)("svg",{"aria-hidden":"true",width:"47",height:"52",viewBox:"0 0 47 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsxs)("g",{mask:"url(#gradient-mask)",children:[(0,y.jsx)("path",{d:"M7 14.5C7 11.4624 9.46243 9 12.5 9H31.5C34.5376 9 37 11.4624 37 14.5V47H7V14.5Z",fill:"var(--ck-graphic-scaniconwithlogos-04)"}),e?(0,y.jsx)("foreignObject",{x:"13",y:"21",width:"18",height:"18",rx:"5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:5},children:e})}):(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)("foreignObject",{x:"12",y:"15",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[0]})}),(0,y.jsx)("foreignObject",{x:"23",y:"15",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[1]})}),(0,y.jsx)("foreignObject",{x:"12",y:"26",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[2]})})}),(0,y.jsx)("foreignObject",{x:"23",y:"26",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[3]})}),(0,y.jsx)("foreignObject",{x:"12",y:"37",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[4]})}),(0,y.jsx)("foreignObject",{x:"23",y:"37",width:"9",height:"9",rx:"2.5",children:(0,y.jsx)("div",{style:{overflow:"hidden",borderRadius:2.5},children:o[5]})})]}),(0,y.jsx)("path",{d:"M36 47V13.7143C36 11.1107 33.8893 9 31.2857 9H12.7143C10.1107 9 8 11.1107 8 13.7143V47",stroke:"url(#paint0_linear_924_12568)",strokeWidth:"2"}),(0,y.jsx)("path",{d:"M15 10H29C29 11.1046 28.1046 12 27 12H17C15.8954 12 15 11.1046 15 10Z",fill:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,y.jsx)("rect",{x:"1",y:"47",width:"43",height:"5",fill:"var(--ck-tooltip-background)"}),(0,y.jsx)("rect",{x:"22",y:"1",width:"24",height:"24",rx:"12",fill:"var(--ck-graphic-scaniconwithlogos-03)",stroke:"var(--ck-tooltip-background)",strokeWidth:"2"}),(0,y.jsx)("rect",{x:"34.5",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,y.jsx)("rect",{x:"31",y:"10",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,y.jsx)("rect",{x:"31",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,y.jsx)("rect",{x:"34.5",y:"13.5",width:"2.5",height:"2.5",rx:"0.75",fill:"#373737"}),(0,y.jsx)("path",{d:"M28.5 10.5V9C28.5 8.17157 29.1716 7.5 30 7.5H31.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,y.jsx)("path",{d:"M36.5 7.5L38 7.5C38.8284 7.5 39.5 8.17157 39.5 9L39.5 10.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,y.jsx)("path",{d:"M39.5 15.5L39.5 17C39.5 17.8284 38.8284 18.5 38 18.5L36.5 18.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,y.jsx)("path",{d:"M31.5 18.5L30 18.5C29.1716 18.5 28.5 17.8284 28.5 17L28.5 15.5",stroke:"#373737",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]}),(0,y.jsxs)("defs",{children:[(0,y.jsxs)("linearGradient",{id:"paint0_linear_924_12568",x1:"22",y1:"8.2549",x2:"22",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,y.jsx)("stop",{stopColor:"var(--ck-graphic-scaniconwithlogos-01)"}),(0,y.jsx)("stop",{offset:"1",stopColor:"var(--ck-graphic-scaniconwithlogos-02)"})]}),(0,y.jsxs)("linearGradient",{id:"linear-gradient-mask",x1:"47",y1:"42",x2:"47",y2:"47",gradientUnits:"userSpaceOnUse",children:[(0,y.jsx)("stop",{stopColor:"white"}),(0,y.jsx)("stop",{offset:"1",stopColor:"black",stopOpacity:"0"})]}),(0,y.jsx)("mask",{id:"gradient-mask",children:(0,y.jsx)("rect",{x:"0",y:"0",width:"47",height:"52",fill:"url(#linear-gradient-mask)"})})]})]})})},ConnectWithQRCode=({connectorId:e})=>{var o,t,n,i,r,a;let s=useContext(),[l]=(0,j.useState)(e),{connectors:d}=useConnect(),{uri:c}=isWalletConnectConnector(l)?useWalletConnectUri():isCoinbaseWalletConnector(l)?function(){let[e,o]=(0,j.useState)(void 0),t=useContext(),n=useConnector("coinbaseWallet"),{connectAsync:i}=useConnect();async function connectWallet(e){let o=await i({connector:e});return!!o&&o}async function connectCoinbaseWallet(e){try{await connectWallet(e)}catch(e){t.log(e),t.displayError((0,y.jsxs)(y.Fragment,{children:["This dApp is most likely missing the ",(0,y.jsx)("code",{children:"headlessMode: true"})," ","flag in the custom ",(0,y.jsx)("code",{children:"CoinbaseWalletConnector"})," options. See"," ",(0,y.jsx)("a",{target:"_blank",rel:"noopener noreferrer",href:"https://connect.family.co/v0/docs/cbwHeadlessMode",children:"documentation"})," ","for more details."]}),e)}}return(0,j.useEffect)(()=>{async function handleMessage(e){if(t.log("CBW Message",e),n&&"connecting"===e.type){let e=await n.getProvider();o(e.qrUrl)}}if(n)return t.log("add cbw listeners"),connectCoinbaseWallet(n),n.on("message",handleMessage),()=>{t.log("remove cbw listeners"),n.off("message",handleMessage)}},[n]),{uri:e}}():{uri:void 0},p=d.find(e=>e.id===l),u=q.find(e=>e.id===l),h=useLocales({CONNECTORNAME:null==p?void 0:p.name}),{open:x,isOpen:g}=useWalletConnectModal();if(!p)return(0,y.jsx)(y.Fragment,{children:"Connector not found"});let b=detectBrowser();(null==u?void 0:u.extensions)&&u.extensions[b];let C=(null==u?void 0:u.appUrls)&&0!==Object.keys(null==u?void 0:u.appUrls).length;if((null==u?void 0:u.extensions)&&(Object.keys(null==u?void 0:u.extensions)[0],null===(o=Object.keys(null==u?void 0:u.extensions)[0])||void 0===o||o.charAt(0).toUpperCase(),null===(t=Object.keys(null==u?void 0:u.extensions)[0])||void 0===t||t.slice(1),null==u||u.extensions[Object.keys(null==u?void 0:u.extensions)[0]]),(null==u?void 0:u.extensionIsInstalled)&&(null==u||u.extensionIsInstalled()),!(null==u?void 0:u.scannable))return(0,y.jsxs)(es,{children:[(0,y.jsx)(ed,{children:"Invalid State"}),(0,y.jsx)(ep,{children:(0,y.jsxs)(Alert,{children:[null==u?void 0:u.name," does not have it's own QR Code to scan. This state should never happen"]})})]});let f=isWalletConnectConnector(e);return(0,y.jsxs)(es,{children:[(0,y.jsxs)(ep,{style:{paddingBottom:8,gap:14},children:[(0,y.jsx)(CustomQRCode,{value:c,image:null==u?void 0:u.logos.qrCode,imageBackground:null==u?void 0:u.logoBackground,tooltipMessage:isWalletConnectConnector(e)?(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(ScanIconWithLogos,{}),(0,y.jsx)("span",{children:h.scanScreen_tooltip_walletConnect})]}):(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(ScanIconWithLogos,{logo:null==u?void 0:u.logos.connectorButton}),(0,y.jsx)("span",{children:h.scanScreen_tooltip_default})]})}),f?(0,y.jsx)(OrDivider,{}):C&&(0,y.jsx)(OrDivider,{children:h.dontHaveTheApp})]}),f&&(0,y.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14},children:[(null===(n=s.options)||void 0===n?void 0:n.walletConnectCTA)!=="modal"&&(0,y.jsx)(CopyToClipboard,{variant:"button",string:c,children:(null===(i=s.options)||void 0===i?void 0:i.walletConnectCTA)==="link"?h.copyToClipboard:h.copyCode}),(null===(r=s.options)||void 0===r?void 0:r.walletConnectCTA)!=="link"&&(0,y.jsx)(Button,{icon:(0,y.jsx)(ExternalLinkIcon,{}),onClick:x,disabled:g,waiting:g,children:(null===(a=s.options)||void 0===a?void 0:a.walletConnectCTA)==="modal"?h.useWalletConnectModal:h.useModal})]}),C&&(0,y.jsx)(y.Fragment,{children:(0,y.jsx)(Button,{onClick:()=>{s.setRoute(nt.DOWNLOAD)},download:!0,children:h.getWalletName})})]})},tw={QRCODE:"qrcode",INJECTOR:"injector"},ConnectUsing=({connectorId:e})=>{let[o,t]=(0,j.useState)(e),n=q.filter(e=>e.id===o)[0],i=n.extensionIsInstalled&&n.extensionIsInstalled(),r=!n.scannable||i,[a,s]=(0,j.useState)(r?tw.INJECTOR:tw.QRCODE);return n?(0,y.jsxs)(M.M,{children:[a===tw.QRCODE&&(0,y.jsx)(E.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:eG,children:(0,y.jsx)(ConnectWithQRCode,{connectorId:o,switchConnectMethod:e=>{e&&t(e),s(tw.INJECTOR)}})},tw.QRCODE),a===tw.INJECTOR&&(0,y.jsx)(E.E.div,{initial:"initial",animate:"animate",exit:"exit",variants:eG,children:(0,y.jsx)(ConnectWithInjector,{connectorId:o,switchConnectMethod:e=>{e&&t(e),s(tw.QRCODE)}})},tw.INJECTOR)]}):(0,y.jsx)(Alert,{children:"Connector not found"})},DownloadApp=({connectorId:e})=>{var o,t,n;let[i]=(0,j.useState)(e),r=q.filter(e=>e.id===i)[0],a=useLocales({CONNECTORNAME:r.name});if(!r)return(0,y.jsx)(y.Fragment,{children:"Connector not found"});let s=null===(o=r.appUrls)||void 0===o?void 0:o.ios,l=null===(t=r.appUrls)||void 0===t?void 0:t.android,d=null===(n=r.appUrls)||void 0===n?void 0:n.download,c=s&&l?a.downloadAppScreen_iosAndroid:s?a.downloadAppScreen_ios:a.downloadAppScreen_android;return(0,y.jsxs)(es,{children:[(0,y.jsxs)(ep,{style:{paddingBottom:4,gap:14},children:[d&&(0,y.jsx)(CustomQRCode,{value:d}),!d&&(0,y.jsx)(y.Fragment,{children:"No download link available"}),(0,y.jsx)(eh,{style:{fontSize:15,lineHeight:"20px",padding:"0 12px"},children:c}),r.defaultConnect&&(0,y.jsx)(OrDivider,{})]}),r.defaultConnect&&(0,y.jsx)(Button,{icon:(0,y.jsx)(ExternalLinkIcon,{}),children:"Open Default Modal"})]})},ty=R(E.E.div)`
  padding: 18px 0 20px;
  @media only screen and (max-width: ${$.mobileWidth}px) {
    padding: 16px 0 20px;
  }
...
`,tI=R(E.E.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${tS} 1000ms linear infinite both;
  }
`,tF=R(E.E.div)`
  ...
  ${e=>{if(e.$seed){let o=Math.ceil(8*(e.$seed.split("").map(e=>e.charCodeAt(0)).reduce((e,o)=>e+o)%100/100)),t=`0${0===o?1:o}`;return I.iv`
...
`,tU=(0,y.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,y.jsx)("defs",{children:(0,y.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,y.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,y.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),ChainSelectList=({variant:e})=>{let{connector:o}=(0,l.mA)(),{chain:t,chains:n}=(0,l.LN)(),{isLoading:i,pendingChainId:r,switchNetwork:a,error:s}=(0,l.g0)(),d=useLocales({}),c=isMobile(),p=(null==s?void 0:s.code)===4902,u=p||!a,handleSwitchNetwork=e=>{a&&a(e)},{triggerResize:h}=useContext();return(0,y.jsxs)(tW,{style:{marginBottom:a?-8:0},children:[(0,y.jsx)(tT,{children:(0,y.jsx)(tR,{children:n.map(n=>{var a;let s=tO.find(e=>e.id===n.id),l={...s,...n};return(0,y.jsxs)(tZ,{$variant:e,disabled:u||l.id===(null==t?void 0:t.id)||i&&r===l.id,onClick:()=>null==handleSwitchNetwork?void 0:handleSwitchNetwork(l.id),style:{opacity:u&&l.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,y.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:l.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,y.jsxs)(tD,{children:[(0,y.jsx)(tz,{initial:{opacity:0},animate:{opacity:i&&r===l.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,y.jsx)(E.E.div,{animate:c&&isCoinbaseWalletConnector(null==o?void 0:o.id)&&i&&r===l.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:tU},`${null==l?void 0:l.id}-${null==l?void 0:l.name}`)}),(0,y.jsx)(tB,{children:null!==(a=l.logo)&&void 0!==a?a:(0,y.jsx)(tA.UnknownChain,{})})]}),l.name]}),"secondary"!==e&&(0,y.jsx)(t_,{children:(0,y.jsxs)(M.M,{initial:!1,exitBeforeEnter:!0,children:[l.id===(null==t?void 0:t.id)&&(0,y.jsx)(E.E.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:d.connected},"connectedText"),i&&r===l.id&&(0,y.jsx)(E.E.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,y.jsx)(E.E.span,{animate:c&&isCoinbaseWalletConnector(null==o?void 0:o.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:d.approveInWallet})},"approveText")]})}),"secondary"===e?(0,y.jsx)(tH,{initial:!1,animate:{opacity:l.id===(null==t?void 0:t.id)?1:0},transition:{duration:.3,ease:"easeOut"}}):l.id===(null==t?void 0:t.id)&&(0,y.jsx)(tH,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==l?void 0:l.id}-${null==l?void 0:l.name}`)})})}),(0,y.jsx)(M.M,{children:p&&(0,y.jsx)(E.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:h,onAnimationComplete:h,children:(0,y.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,y.jsxs)(Alert,{children:[d.warnings_walletSwitchingUnsupported," ",d.warnings_walletSwitchingUnsupportedResolve]})})})})]})},tG=R(E.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,tV=R(E.E.div)`
...
`,tY=R(E.E.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,ChainSelectDropdown=({children:e,open:o,onClose:t,offsetX:n=0,offsetY:i=8})=>{var r,a,s;let l=useContext(),d=useThemeContext(),c=useLocales(),[p,u]=(0,j.useState)({x:0,y:0});useLockBodyScroll(o);let h=(0,j.useRef)(null);(0,j.useEffect)(()=>{let listener=e=>{var n,i,r;if(o&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!h.current)return;e.preventDefault();let o=null===(n=h.current)||void 0===n?void 0:n.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=o[0],a=o[o.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",listener),()=>{document.removeEventListener("keydown",listener)}},[o]);let x=(0,j.useRef)(null),g=(0,j.useCallback)(e=>{e&&(x.current=e,refresh())},[o]),[b,C]=(0,A.Z)({debounce:120,offsetSize:!0,scroll:!0}),refresh=()=>{if(!x.current||C.top+C.bottom+C.left+C.right+C.height+C.width===0)return;let e=C.left+n,o=C.top+C.height+i;x.current.style.left=`${e}px`,x.current.style.top=`${o}px`},f="undefined"!=typeof window?j.useLayoutEffect:j.useEffect;return f(refresh,[x.current,C,o]),(0,j.useEffect)(refresh,[o,x.current]),(0,j.useEffect)(()=>(refresh(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)("div",{ref:b,children:e}),(0,y.jsx)(M.M,{children:o&&(0,y.jsx)(Portal,{children:(0,y.jsx)(Q,{$useTheme:null!==(r=d.theme)&&void 0!==r?r:l.theme,$useMode:null!==(a=d.mode)&&void 0!==a?a:l.mode,$customTheme:null!==(s=d.customTheme)&&void 0!==s?s:l.customTheme,children:(0,y.jsx)(FocusTrap,{children:(0,y.jsxs)(tG,{ref:h,children:[(0,y.jsx)(tV,{onClick:t}),(0,y.jsxs)(tP,{ref:g,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,y.jsx)(tY,{children:c.switchNetworks}),(0,y.jsx)(ChainSelectList,{})]})]})})})})})]})},tQ=R.div`
  --bg: transparent;
  --color: #333;
  ${e=>"string"==typeof e.size?I.iv`
          --width: ${e.size};
          --height: ${e.size};
        `:I.iv`
...
`,t$=(0,y.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,y.jsx)("defs",{children:(0,y.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,y.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,y.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),Chain=({id:e,unsupported:o,radius:t="50%",size:n=24})=>{var i;let r=tO.find(o=>o.id===e),a=useIsMounted();return a?(0,y.jsx)(tQ,{size:n,radius:t,children:(0,y.jsxs)(M.M,{initial:!1,children:[o&&(0,y.jsx)(tK,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,y.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,y.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,y.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,y.jsx)(tJ,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!==(i=null==r?void 0:r.logo)&&void 0!==i?i:(0,y.jsx)(tA.UnknownChain,{})},`${null==r?void 0:r.id}-${null==r?void 0:r.name}-${e}`):(0,y.jsx)(tq,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:t$},"loading")]})}):(0,y.jsx)("div",{style:{width:n,height:n}})},t1=R(E.E.div)``,t0=R(E.E.button)`
  ...
  ${e=>e.disabled?I.iv`
        ...
        `}
`,ChevronDown=({...e})=>(0,y.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,y.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),ChainSelector=()=>{let e=useContext(),[o,t]=(0,j.useState)(!1),{chain:n,chains:i}=(0,l.LN)(),r=useLocales({CHAIN:null==n?void 0:n.name}),a=isMobile()||(null==window?void 0:window.innerWidth)<$.mobileWidth;(0,j.useEffect)(()=>{e.open||t(!1)},[e.open]);let s=i.length<=1;return(0,y.jsx)(y.Fragment,{children:(0,y.jsx)(t1,{children:(0,y.jsx)(ChainSelectDropdown,{offsetX:-12,open:!a&&o,onClose:()=>t(!1),children:(0,y.jsxs)(t0,{"aria-label":flattenChildren(r.switchNetworks).toString(),disabled:s,onClick:()=>{a?e.setRoute(nt.SWITCHNETWORKS):t(!o)},children:[s?(0,y.jsx)(Tooltip,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,y.jsx)(Chain,{id:null==n?void 0:n.id,unsupported:null==n?void 0:n.unsupported})}):(0,y.jsx)(Chain,{id:null==n?void 0:n.id,unsupported:null==n?void 0:n.unsupported}),!s&&(0,y.jsx)(ChevronDown,{style:{top:1,left:-3}})]})})})})},Profile=({closeModal:e})=>{var o,t,n;let i=useContext(),r=useThemeContext(),a=useLocales(),{reset:s}=(0,l.$4)(),{disconnect:d}=(0,l.qL)(),{chain:c}=(0,l.LN)(),{address:p,isConnected:u,connector:h}=(0,l.mA)(),{data:x}=(0,l.F6)({chainId:1,address:p}),{data:g}=(0,l.KQ)({address:p}),[b,C]=(0,j.useState)(!1);(0,j.useEffect)(()=>{u||i.setOpen(!1)},[u]),(0,j.useEffect)(()=>{if(b)return e?e():i.setOpen(!1),()=>{d(),s()}},[b,d,s]);let f=["web95","rounded","minimal"].includes(null!==(t=null!==(o=r.theme)&&void 0!==o?o:i.theme)&&void 0!==t?t:"")?"....":void 0;return(0,y.jsxs)(es,{children:[(0,y.jsxs)(ep,{style:{paddingBottom:22,gap:6},children:[(0,y.jsx)(ty,{children:(0,y.jsxs)(tj,{children:[(0,y.jsx)(tL,{children:(0,y.jsx)(ChainSelector,{})}),(0,y.jsx)(Avatar,{address:p})]})}),(0,y.jsx)(eu,{children:(0,y.jsx)(CopyToClipboard,{string:p,children:null!=x?x:truncateEthAddress(p,f)})}),(null===(n=null==i?void 0:i.options)||void 0===n?void 0:n.hideBalance)?null:(0,y.jsx)(eh,{children:(0,y.jsx)(tE,{children:(0,y.jsxs)(M.M,{exitBeforeEnter:!0,initial:!1,children:[g&&(0,y.jsxs)(tM,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[nFormatter(Number(null==g?void 0:g.formatted))," ",null==g?void 0:g.symbol]},`chain-${null==c?void 0:c.id}`),!g&&(0,y.jsx)(tI,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),!isSafeConnector(null==h?void 0:h.id)&&(0,y.jsx)(Button,{onClick:()=>C(!0),icon:(0,y.jsx)(DisconnectIcon,{}),children:a.disconnect})]})},SwitchNetworks=()=>{let{reset:e}=(0,l.$4)(),{disconnect:o}=(0,l.qL)(),{chain:t}=(0,l.LN)(),{connector:n}=(0,l.mA)(),i=useLocales({});return(0,y.jsx)(es,{style:{width:278},children:(0,y.jsxs)(ep,{style:{padding:0,marginTop:-10},children:[(null==t?void 0:t.unsupported)&&(0,y.jsxs)(eh,{children:[i.warnings_chainUnsupported," ",i.warnings_chainUnsupportedResolve]}),(0,y.jsx)("div",{style:{padding:"6px 8px"},children:(0,y.jsx)(ChainSelectList,{variant:"secondary"})}),(null==t?void 0:t.unsupported)&&!isSafeConnector(null==n?void 0:n.id)&&(0,y.jsxs)("div",{style:{paddingTop:12},children:[(0,y.jsx)(OrDivider,{}),(0,y.jsx)(Button,{icon:(0,y.jsx)(DisconnectIcon,{}),variant:"secondary",onClick:()=>{o(),e()},children:i.disconnect})]})]})})},t2=I.F4`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,t3=I.F4`
...
`,t8=R(E.E.div)`
  ...
  ${({$connected:e})=>e&&I.iv`
    ...
    `};
`,SIWEButton=({showSignOutButton:e,onSignIn:o,onSignOut:t})=>{let n=useIsMounted(),i=useLocales(),{setOpen:r}=useModal(),{isSignedIn:a,isReady:s,isLoading:d,isRejected:c,isSuccess:p,isError:u,signIn:h,signOut:x,error:g}=useSIWE({onSignIn:e=>null==o?void 0:o(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,l.mA)();return n?e&&a?(0,y.jsx)(Button,{style:{margin:0},onClick:x,icon:(0,y.jsx)(DisconnectIcon,{}),children:i.signOut},"button"):b?(0,y.jsx)(Button,{style:{margin:0},arrow:!a&&!d&&!c,onClick:d||p?void 0:h,disabled:d,waiting:d,icon:c&&(0,y.jsx)(E.E.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,y.jsx)(RetryIcon,{style:{opacity:.4}})}),children:p?i.signedIn:c?i.tryAgain:d?i.awaitingConfirmation:u?null!=g?g:"Unknown Error":i.signIn},"button"):(0,y.jsx)(Button,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,y.jsx)(Button,{style:{margin:0},disabled:!0},"loading")},LazyImage=({src:e,alt:o,width:t,height:n})=>{let i=(0,j.useRef)(null),[r,a]=(0,j.useState)(!0);return(0,j.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,y.jsx)("div",{style:{width:t,height:n,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,y.jsx)("img",{ref:i,src:e,alt:o,width:t,height:n,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:r?1:0}})})},t7={duration:.2,ease:[.26,.08,.25,1]},ne={duration:.16,ease:[.26,.08,.25,1]},SignInWithEthereum=()=>{var e,o;let t=useContext(),{isSignedIn:n,reset:i}=useSIWE(),r=isMobile(),[a,s]=(0,j.useState)(n?"signedIn":"signedOut"),d=useLocales({}),c="signedIn"===a?{heading:d.signInWithEthereumScreen_signedIn_heading,h1:d.signInWithEthereumScreen_signedIn_h1,p:d.signInWithEthereumScreen_signedIn_p,button:d.signInWithEthereumScreen_signedIn_button}:{heading:d.signInWithEthereumScreen_signedOut_heading,h1:d.signInWithEthereumScreen_signedOut_h1,p:d.signInWithEthereumScreen_signedOut_p,button:d.signInWithEthereumScreen_signedOut_button};(0,j.useEffect)(()=>{n&&s("signedIn")},[]),(0,j.useEffect)(()=>{n||s("signedOut")},[n]);let{address:p}=(0,l.mA)(),u=(()=>{let e={svg:null,default:null},o=document.getElementsByTagName("link");return Array.from(o).forEach(o=>{("icon"===o.getAttribute("rel")||"shortcut icon"===o.getAttribute("rel"))&&o.getAttribute("href")&&("image/svg+xml"===o.getAttribute("type")?e.svg=o.getAttribute("href"):e.default=o.getAttribute("href"))}),e})(),h=null!==(o=null!==(e=getAppIcon())&&void 0!==e?e:u.svg)&&void 0!==o?o:u.default;return(0,y.jsx)(es,{style:{width:278},children:(0,y.jsxs)(ep,{style:{padding:0,marginTop:-10},children:[(0,y.jsx)(t5,{children:(0,y.jsx)(M.M,{exitBeforeEnter:!0,children:(0,y.jsx)(E.E.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:ne,children:(0,y.jsx)(eh,{style:{height:42},children:(0,y.jsx)(FitText,{children:c.h1})})},flattenChildren(c.h1).toString())})}),(0,y.jsxs)(t8,{$connected:n,children:[(0,y.jsx)("div",{style:{position:"absolute",inset:0},children:(0,y.jsx)(t6,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,y.jsx)(E.E.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,y.jsx)(E.E.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:t7,children:(0,y.jsx)(t4,{children:(0,y.jsx)(Avatar,{address:p,size:64})})},"avatarImage"),(0,y.jsx)(E.E.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...t7},children:(0,y.jsx)(t9,{children:(0,y.jsx)(TickIcon,{})})},"tickIcon"),(0,y.jsx)(E.E.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...t7},children:(0,y.jsx)(t4,{children:h?(0,y.jsx)(LazyImage,{src:h,alt:"app"}):(0,y.jsx)(tA.UnknownChain,{})})},"appLogo")]},"status"),(0,y.jsx)(M.M,{exitBeforeEnter:!0,children:(0,y.jsx)(E.E.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:ne,children:(0,y.jsx)(eh,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,y.jsx)(FitText,{children:c.p})})},flattenChildren(c.p).toString())}),(0,y.jsx)(SIWEButton,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},no={},ConnectModal$1=({mode:e="auto",theme:o="auto",customTheme:t=no,lang:n="en-US"})=>{var i;let r=useContext(),{isConnected:a}=(0,l.mA)(),{chain:s}=(0,l.LN)(),d=!((null===(i=r.options)||void 0===i?void 0:i.enforceSupportedChains)&&(null==s?void 0:s.unsupported)),c=d&&r.route!==nt.CONNECTORS&&r.route!==nt.PROFILE,p=d&&r.route!==nt.PROFILE,u={onboarding:(0,y.jsx)(Introduction,{}),about:(0,y.jsx)(About,{}),download:(0,y.jsx)(DownloadApp,{connectorId:r.connector}),connectors:(0,y.jsx)(Wallets,{}),mobileConnectors:(0,y.jsx)(MobileConnectors,{}),connect:(0,y.jsx)(ConnectUsing,{connectorId:r.connector}),profile:(0,y.jsx)(Profile,{}),switchNetworks:(0,y.jsx)(SwitchNetworks,{}),signInWithEthereum:(0,y.jsx)(SignInWithEthereum,{})};function hide(){r.setOpen(!1)}return(0,j.useEffect)(()=>{var e;a?(r.route!==nt.PROFILE||r.route!==nt.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null===(e=r.options)||void 0===e?void 0:e.disableSiweRedirect)?hide():r.setRoute(nt.SIGNINWITHETHEREUM)):hide()},[a]),(0,j.useEffect)(()=>r.setMode(e),[e]),(0,j.useEffect)(()=>r.setTheme(o),[o]),(0,j.useEffect)(()=>r.setCustomTheme(t),[t]),(0,j.useEffect)(()=>r.setLang(n),[n]),(0,j.useEffect)(()=>{let e=getAppName();if(!e||!r.open)return;let o=document.createElement("meta");return o.setAttribute("property","og:title"),o.setAttribute("content",e),document.head.prepend(o),()=>{document.head.removeChild(o)}},[r.open]),(0,y.jsx)(ConnectKitThemeProvider,{theme:o,customTheme:t,mode:e,children:(0,y.jsx)(Modal,{open:r.open,pages:u,pageId:r.route,onClose:d?hide:void 0,onInfo:p?()=>r.setRoute(nt.ABOUT):void 0,onBack:c?()=>{r.route===nt.SIGNINWITHETHEREUM?r.setRoute(nt.PROFILE):r.route===nt.SWITCHNETWORKS?r.setRoute(nt.PROFILE):r.route===nt.DOWNLOAD?r.setRoute(nt.CONNECT):r.setRoute(nt.CONNECTORS)}:void 0})})},useConnectCallback=({onConnect:e,onDisconnect:o})=>{(0,l.mA)({onConnect:({address:o,connector:t,isReconnected:n})=>{n||null==e||e({address:o,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==o?void 0:o()})},nt={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},nn=(0,j.createContext)(null),ConnectKitProvider=({children:e,theme:o="auto",mode:t="auto",customTheme:n,options:i,onConnect:r,onDisconnect:a,debugMode:s=!1})=>{var d,c,p,u;if(j.useContext(nn))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");useConnectCallback({onConnect:r,onDisconnect:a});let h=function(){var e;let o=useConnectors();return null===(e=o[0])||void 0===e?void 0:e.chains}(),x=useConnector("injected"),g={language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null===(d=null==h?void 0:h[0])||void 0===d?void 0:d.id,enforceSupportedChains:!0,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},b=Object.assign({},g,i);"undefined"!=typeof window&&b.bufferPolyfill&&(window.Buffer=null!==(c=window.Buffer)&&void 0!==c?c:L.Buffer);let[C,f]=(0,j.useState)(o),[m,v]=(0,j.useState)(t),[k,w]=(0,j.useState)(null!=n?n:{}),[E,M]=(0,j.useState)("en-US"),[S,F]=(0,j.useState)(!1),[N,A]=(0,j.useState)(""),[O,W]=(0,j.useState)(nt.CONNECTORS),[B,D]=(0,j.useState)(""),[z,R]=(0,j.useState)(0);b.embedGoogleFonts&&function(e){var o,t;let n=null!==(o=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])&&void 0!==o?o:null;t=null!=n?n:"",(0,j.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let o=document.createElement("link");o.href="https://fonts.gstatic.com",o.rel="preconnect",o.crossOrigin="true";let n=document.createElement("link");return n.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,n.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(o),document.head.appendChild(n),()=>{document.head.removeChild(e),document.head.removeChild(o),document.head.removeChild(n)}},[t])}(o),(0,j.useEffect)(()=>f(o),[o]),(0,j.useEffect)(()=>M(b.language||"en-US"),[b.language]),(0,j.useEffect)(()=>D(null),[O,S]);let{chain:Z}=(0,l.LN)();(0,j.useEffect)(()=>{b.enforceSupportedChains&&(null==Z?void 0:Z.unsupported)&&(F(!0),W(nt.SWITCHNETWORKS))},[Z,O,S]),(0,j.useEffect)(()=>{isFamily()&&(null==x||x.connect())},[x]);let _=s?console.log:()=>{},H={theme:C,setTheme:f,mode:m,setMode:v,customTheme:n,setCustomTheme:w,lang:E,setLang:M,open:S,setOpen:F,route:O,setRoute:W,connector:N,setConnector:A,signInWithEthereum:null!==(u=null===(p=j.useContext(eB))||void 0===p?void 0:p.enabled)&&void 0!==u&&u,onConnect:r,options:b,errorMessage:B,debugMode:s,log:_,displayError:(e,o)=>{D(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),o&&console.table(o),console.log("---------/CONNECTKIT DEBUG---------")},resize:z,triggerResize:()=>R(e=>e+1)};return(0,j.createElement)(nn.Provider,{value:H},(0,y.jsx)(y.Fragment,{children:(0,y.jsxs)(I.f6,{theme:T,children:[e,(0,y.jsx)(ConnectModal$1,{lang:E,theme:C,mode:t,customTheme:k})]})}))},useContext=()=>{let e=j.useContext(nn);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},ni={disconnected:[nt.CONNECTORS,nt.ABOUT,nt.ONBOARDING,nt.MOBILECONNECTORS,nt.ONBOARDING],connected:[nt.PROFILE,nt.SWITCHNETWORKS,nt.SIGNINWITHETHEREUM]},nr=[...ni.connected,...ni.disconnected],useModal=({onConnect:e,onDisconnect:o}={})=>{let t=useContext();useConnectCallback({onConnect:e,onDisconnect:o});let{isConnected:n}=(0,l.mA)(),{signIn:i}=useSIWE(),close=()=>{t.setOpen(!1)},open=()=>{t.setOpen(!0)},gotoAndOpen=e=>{let o=e;nr.includes(e)?n?ni.connected.includes(e)||(o=nt.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${o} instead.`)):ni.disconnected.includes(e)||(o=nt.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${o} instead.`)):(o=n?nt.PROFILE:nt.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${o} instead.`)),t.setRoute(o),open()};return{open:t.open,setOpen:e=>{e?gotoAndOpen(n?nt.PROFILE:nt.CONNECTORS):close()},openAbout:()=>gotoAndOpen(nt.ABOUT),openOnboarding:()=>gotoAndOpen(nt.ONBOARDING),openProfile:()=>gotoAndOpen(nt.PROFILE),openSwitchNetworks:()=>gotoAndOpen(nt.SWITCHNETWORKS),openSIWE:e=>{gotoAndOpen(nt.SIGNINWITHETHEREUM),e&&i()}}},na=R(E.E.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,nh=R.div`
  ...
  span {
    ...
    border-radius: 4px;
    background: currentColor;
    animation: ${nu} 1000ms ease infinite both;
  }
`,Balance=({hideIcon:e,hideSymbol:o})=>{let t=useIsMounted(),[n,i]=(0,j.useState)(!0),{address:r}=(0,l.mA)(),{chain:a}=(0,l.LN)(),{data:s}=(0,l.KQ)({address:r,chainId:null==a?void 0:a.id,watch:!0}),d=tO.find(e=>e.id===(null==a?void 0:a.id)),c=`${t&&(null==s?void 0:s.formatted)!==void 0?`balance-${null==d?void 0:d.id}-${null==s?void 0:s.formatted}`:"balance-loading"}`;return(0,j.useEffect)(()=>{i(!1)},[]),(0,y.jsx)("div",{style:{position:"relative"},children:(0,y.jsx)(M.M,{initial:!1,children:(0,y.jsx)(E.E.div,{initial:(null==s?void 0:s.formatted)!==void 0&&n?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==s?void 0:s.formatted)!==void 0?(null==a?void 0:a.unsupported)?(0,y.jsxs)(np,{children:[!e&&(0,y.jsx)(Chain,{id:null==a?void 0:a.id}),(0,y.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,y.jsxs)(np,{children:[!e&&(0,y.jsx)(Chain,{id:null==a?void 0:a.id}),(0,y.jsx)("span",{style:{minWidth:32},children:nFormatter(Number(null==s?void 0:s.formatted))}),!o&&` ${null==s?void 0:s.symbol}`]}):(0,y.jsxs)(np,{children:[!e&&(0,y.jsx)(Chain,{}),(0,y.jsx)("span",{style:{minWidth:32},children:(0,y.jsxs)(nh,{children:[(0,y.jsx)("span",{style:{animationDelay:"0ms"}}),(0,y.jsx)("span",{style:{animationDelay:"50ms"}}),(0,y.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},c)})})},nx={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},ng={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},nb={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},ConnectButtonRenderer=({children:e})=>{let o=useIsMounted(),t=useContext(),{open:n,setOpen:i}=useModal(),{chain:r}=(0,l.LN)(),{address:a,isConnected:s}=(0,l.mA)(),{data:d}=(0,l.F6)({chainId:1,address:a});return e&&o?(0,y.jsx)(y.Fragment,{children:e({show:function(){i(!0),t.setRoute(s?nt.PROFILE:nt.CONNECTORS)},hide:function(){i(!1)},chain:r,unsupported:!!(null==r?void 0:r.unsupported),isConnected:!!a,isConnecting:n,address:a,truncatedAddress:a?truncateEthAddress(a):void 0,ensName:null==d?void 0:d.toString()})}):null};function ConnectKitButtonInner({label:e,showAvatar:o,separator:t}){var n;let i=useLocales({}),r=useContext(),{isSignedIn:a}=useSIWE(),{address:s}=(0,l.mA)(),{data:d}=(0,l.F6)({chainId:1,address:s}),{chain:c}=(0,l.LN)(),p=i.connectWallet;return(0,y.jsx)(M.M,{initial:!1,children:s?(0,y.jsxs)(na,{initial:"initial",animate:"animate",exit:"exit",variants:ng,style:{height:40},children:[o&&(0,y.jsxs)(ns,{children:[(0,y.jsxs)(M.M,{initial:!1,children:[a&&(0,y.jsx)(E.E.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,y.jsx)(AuthIcon,{})}),(null==c?void 0:c.unsupported)&&(0,y.jsx)(nl,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,y.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,y.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,y.jsx)(Avatar,{size:24,address:s})]}),(0,y.jsx)("div",{style:{position:"relative",paddingRight:o?1:0},children:(0,y.jsx)(M.M,{initial:!1,children:d?(0,y.jsx)(na,{initial:"initial",animate:"animate",exit:"exit",variants:nb,style:{position:d?"relative":"absolute"},children:(null===(n=r.options)||void 0===n?void 0:n.truncateLongENSAddress)?truncateENSAddress(d,20):d},"ckEnsName"):(0,y.jsxs)(na,{initial:"initial",animate:"animate",exit:"exit",variants:nb,style:{position:d?"absolute":"relative"},children:[truncateEthAddress(s,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,y.jsx)(na,{initial:"initial",animate:"animate",exit:"exit",variants:nx,style:{height:40},children:e||p},"connectWalletText")})}function ConnectKitButton({label:e,showBalance:o=!1,showAvatar:t=!0,theme:n,mode:i,customTheme:r,onClick:a}){var s;let d=useIsMounted(),c=useContext(),{isConnected:p,address:u}=(0,l.mA)(),{chain:h}=(0,l.LN)();function show(){c.setOpen(!0),c.setRoute(p?nt.PROFILE:nt.CONNECTORS)}let x=["web95","rounded","minimal"].includes(null!==(s=null!=n?n:c.theme)&&void 0!==s?s:"")?"....":void 0;if(!d)return null;let g=o&&!(null==h?void 0:h.unsupported);return(0,y.jsx)(Q,{$useTheme:null!=n?n:c.theme,$useMode:null!=i?i:c.mode,$customTheme:null!=r?r:c.customTheme,children:(0,y.jsxs)(nc,{onClick:()=>{a?a(show):show()},children:[g&&(0,y.jsx)(M.M,{initial:!1,children:u&&g&&(0,y.jsx)(E.E.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,y.jsx)(ThemedButton,{variant:"secondary",theme:null!=n?n:c.theme,mode:null!=i?i:c.mode,customTheme:null!=r?r:c.customTheme,style:{overflow:"hidden"},children:(0,y.jsx)(E.E.div,{style:{paddingRight:24},children:(0,y.jsx)(Balance,{hideSymbol:!0})})})},"balance")}),(0,y.jsx)(ThemedButton,{theme:null!=n?n:c.theme,mode:null!=i?i:c.mode,customTheme:null!=r?r:c.customTheme,style:g&&o&&u&&("retro"===n||"retro"===c.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,y.jsx)(ConnectKitButtonInner,{separator:x,showAvatar:t,label:e})})]})})}ConnectButtonRenderer.displayName="ConnectKitButton.Custom",ConnectKitButton.Custom=ConnectButtonRenderer;let nC=I.F4`
  0%{ transform:none; }
...
`;R.div`
  ...
  opacity: 0;
  &.play {
    animation: ${nf} 1300ms 200ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,R.div`
  z-index: 1;
  position: absolute;
  inset: 0;
  &.shake {
    animation: ${nC} 300ms 100ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,R.div`
  z-index: 1;
  position: absolute;
